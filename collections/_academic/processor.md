---
layout: post
title:  "Single Cycle 16-Bit Processor"
date:   2025-3-1 10:00:40
description: "In the fall of 2023, for a Digital Logic Design class, I developed a single-cycle 16-bit processor in Verilog supporting arithmetic and logic instructions. Additionally, I integrated I/O via switches and buttons to execute custom assembly instruction sequences. After writing the code, I simulated and verified its functionality using Vivado, then programmed it onto a Real Digital Boolean Board."
image: 
    src: /assets/img/content/thumbnails/processor.jpg
    alt: banner
order_number: 5
---
